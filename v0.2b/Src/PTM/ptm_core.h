...
void ptm_set_var(string name, string value, bool negative_sign = false);
void ptm_set_var(string name, int value, bool negative_sign = false);
...
void ptm_def_const(string name, string value, bool negative_sign = false);
void ptm_def_const(string name, int value, bool negative_sign = false);
